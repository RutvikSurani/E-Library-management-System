<?php session_start(); ?>
  ...
  <body>
      ...
      <?php
		...
		$query = $conn->query("SELECT * FROM book  where b_name='$a' ORDER BY upload_on DESC");
		if ($query->num_rows > 0) {
  			...
  			<div class="card mb-3" style="max-width: 700px;">
  				<div class="row no-gutters">
  					<div class="col-md-6">
  						...
  						<?php } else { ?>
  							<a onclick="A()" href="1.php"><img src="<?php echo $imageURL; ?>" width="330px" height="200px"></img></a>
